...
public class FluxoFilterFunctionOld extends FunctionExpressionImpl implements
    ...
    public static FunctionName NAME = new FunctionNameImpl("fluxo_old", Geometry.class,
    ...
    public FluxoFilterFunctionOld() {
        super(NAME);
    }

    public FluxoFilterFunctionOld(List<Expression> parameters, Literal fallback) {
        super(NAME);
    ...
    public Object evaluate(Object feature) {
        ...
        try {
            ...
            Logger.getLogger(FluxoFilterFunctionOld.class.getName()).log(Level.INFO, "Output CRS:{0}", ""+outCRS);
            if (outCRS!=null && outCRS.getCoordinateSystem()!=null && outCRS.getCoordinateSystem().getIdentifiers()!=null) {
                Logger.getLogger(FluxoFilterFunctionOld.class.getName()).log(Level.INFO, "SRS identifier of the output coordinate system:{0}", outCRS.getCoordinateSystem().getIdentifiers().toString());                
            }
            if (geom!=null && geom.getUserData()!=null) {
                Logger.getLogger(FluxoFilterFunctionOld.class.getName()).log(Level.INFO, "CRS value read by the geometry of the db:{0}", ((CoordinateReferenceSystem) geom.getUserData()).toString());       
            }
            Logger.getLogger(FluxoFilterFunctionOld.class.getName()).log(Level.INFO, "Output Boundind Box:{0}", ""+outBBox);            
            Logger.getLogger(FluxoFilterFunctionOld.class.getName()).log(Level.SEVERE, null, ex);
        }
        return geom;
    }
