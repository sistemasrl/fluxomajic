...
public class FluxoFunctionFactory implements FunctionFactory {    
    ...
    public List<FunctionName> getFunctionNames() {
        ...
        //initialize cache
        FluxoFilterFunction.hash_features=new Hashtable<Request, Geometry>();
        FluxoFilterFunction.cache_features=CacheBuilder.newBuilder()
        		.maximumSize(10)
        		.build(new CacheLoader<Request, Geometry>(){
					@Override
					public Geometry load(Request request) throws Exception {
						return request.getFluxoFilterFunction()
