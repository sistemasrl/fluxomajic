...
//        sb.append(offsetPx).append(widthPx).append(dMode).append(quadseg).append(endcap).append(join).append(scalingWidth).append(wmsWidth).append(wmsHeight);
//        sb.append(FluxoFilterFunction.wktWriter.write(geom));
//        sb.append(outBBox.toString());
//        sb.append(outCRS.toString());       
//        return sb.toString();
    
        return ""+offsetPx+widthPx+dMode+quadseg+endcap+join+scalingWidth+wmsWidth+wmsHeight+FluxoFilterFunction.wktWriter.write(geom)/*+outBBox.toString()+outCRS.toString()*/;
//        return "";
    }
	...
	public boolean equals(Object obj) {
		...
		if(!geom.equalsExact(request.geom)) return false;
